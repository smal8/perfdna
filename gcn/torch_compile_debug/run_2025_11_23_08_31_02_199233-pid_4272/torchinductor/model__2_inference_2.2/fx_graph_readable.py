class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: "i64[2, 13264]"):
        ...
        select: "i64[13264]" = torch.ops.aten.select.int(arg0_1, 0, 0)
        select_1: "i64[13264]" = torch.ops.aten.select.int(arg0_1, 0, 1);  arg0_1 = None
        ...
        view: "i64[13264]" = torch.ops.aten.view.default(select_1, [-1])
