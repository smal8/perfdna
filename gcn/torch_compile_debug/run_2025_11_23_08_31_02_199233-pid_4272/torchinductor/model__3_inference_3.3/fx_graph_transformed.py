class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: "f32[16, 1433]", arg1_1: "f32[16]", arg2_1: "i64[2, 13264]", arg3_1: "f32[13264]", arg4_1: "f32[2708, 1433]"):
        ...
        full_default: "f32[2708, 16]" = torch.ops.aten.full.default([2708, 16], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        ...
        view_1: "i64[13264, 1]" = torch.ops.aten.reshape.default(select, [-1, 1]);  select = None
        expand: "i64[13264, 16]" = torch.ops.aten.expand.default(view_1, [13264, 16]);  view_1 = None
        ...
        view: "f32[13264, 1]" = torch.ops.aten.reshape.default(arg3_1, [-1, 1]);  arg3_1 = None
        ...
        permute: "f32[1433, 16]" = torch.ops.aten.permute.default(arg0_1, [1, 0]);  arg0_1 = None
        mm: "f32[2708, 16]" = torch.ops.aten.mm.default(arg4_1, permute);  arg4_1 = permute = None
        ...
        index: "f32[13264, 16]" = torch.ops.aten.index.Tensor(mm, [select_1]);  mm = select_1 = None
        
        # File: /usr/local/lib/python3.12/dist-packages/torch_geometric/nn/conv/gcn_conv.py:271 in message, code: return x_j if edge_weight is None else edge_weight.view(-1, 1) * x_j
        mul: "f32[13264, 16]" = torch.ops.aten.mul.Tensor(view, index);  view = index = None
        
        # File: /usr/local/lib/python3.12/dist-packages/torch_geometric/utils/_scatter.py:70 in scatter, code: return src.new_zeros(size).scatter_add_(dim, index, src)
        scatter_add: "f32[2708, 16]" = torch.ops.aten.scatter_add.default(full_default, 0, expand, mul);  full_default = expand = mul = None
        ...
        add: "f32[2708, 16]" = torch.ops.aten.add.Tensor(scatter_add, arg1_1);  scatter_add = arg1_1 = None
        return (add,)
