...
# kernel path: /tmp/torchinductor_root/nh/cnhg7rkz6uf2tdc2mfx566amzhj7aiarepmbz24cglzxwkgstjla.py
...
# kernel path: /tmp/torchinductor_root/67/c67wfzqklzecifld6uuw6qpu23lcsbpdz7wmwxtpbx37ckjhs4mp.py
# Source Nodes: [new_zeros, out, out_1, x_j], Original ATen: [aten.index_select, aten.mul, aten.new_zeros, aten.scatter_add]
# new_zeros => full_default
# out => mul
# out_1 => scatter_add
...
def triton_(in_ptr0, in_ptr1, in_ptr2, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp12 = tl.load(in_ptr2 + (x0 + (16*tmp10)), xmask)
    tmp13 = tmp6 * tmp12
    tl.atomic_add(out_ptr0 + (x0 + (16*tmp4)), tmp13, xmask)
''', device_str='cuda')


# kernel path: /tmp/torchinductor_root/vl/cvlhdt5eea2275i2e3eichkny63vo7qx4qyxysbrlp3m23ybu3nh.py
...
def call(args):
    ...
    args.clear()
    assert_size_stride(arg0_1, (16, 1433), (1433, 1))
    assert_size_stride(arg1_1, (16, ), (1, ))
    assert_size_stride(arg2_1, (2, 13264), (13264, 1))
    assert_size_stride(arg3_1, (13264, ), (1, ))
    assert_size_stride(arg4_1, (2708, 1433), (1433, 1))
    with torch.cuda._DeviceGuard(0):
        torch.cuda.set_device(0)
        buf0 = empty_strided_cuda((2708, 16), (16, 1), torch.float32)
        # Source Nodes: [x], Original ATen: [aten.mm]
        extern_kernels.mm(arg4_1, reinterpret_tensor(arg0_1, (1433, 16), (1, 1433), 0), out=buf0)
        del arg0_1
        del arg4_1
        buf1 = empty_strided_cuda((2708, 16), (16, 1), torch.float32)
        # Source Nodes: [new_zeros, out, out_1, x_j], Original ATen: [aten.index_select, aten.mul, aten.new_zeros, aten.scatter_add]
        stream0 = get_raw_stream(0)
        triton_poi_fused_index_select_mul_new_zeros_scatter_add_0.run(buf1, 43328, grid=grid(43328), stream=stream0)
        # Source Nodes: [new_zeros, out, out_1, x_j], Original ATen: [aten.index_select, aten.mul, aten.new_zeros, aten.scatter_add]
        triton_poi_fused_index_select_mul_new_zeros_scatter_add_1.run(arg2_1, arg3_1, buf0, buf1, 212224, grid=grid(212224), stream=stream0)
        del arg2_1
        del arg3_1
        buf3 = buf0; del buf0  # reuse
        # Source Nodes: [out_2], Original ATen: [aten.add]
        triton_poi_fused_add_2.run(buf1, arg1_1, buf3, 43328, grid=grid(43328), stream=stream0)
        del arg1_1
        del buf1
    return (buf3, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg0_1 = rand_strided((16, 1433), (1433, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg4_1 = rand_strided((2708, 1433), (1433, 1), device='cuda:0', dtype=torch.float32)
