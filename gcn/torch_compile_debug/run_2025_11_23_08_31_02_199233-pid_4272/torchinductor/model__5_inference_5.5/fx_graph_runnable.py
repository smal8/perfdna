...
class Repro(torch.nn.Module):
    ...
    def forward(self, arg0_1, arg1_1, arg2_1, arg3_1, arg4_1):
        ...
        expand = torch.ops.aten.expand.default(view_1, [13264, 7]);  view_1 = None
        full_default = torch.ops.aten.full.default([2708, 7], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
...
def load_args(reader):
    buf0 = reader.storage(None, 448, device=device(type='cuda', index=0))
    reader.tensor(buf0, (7, 16), is_leaf=True)  # arg0_1
    buf1 = reader.storage(None, 28, device=device(type='cuda', index=0))
    reader.tensor(buf1, (7,), is_leaf=True)  # arg1_1
    ...
    buf4 = reader.storage(None, 173312, device=device(type='cuda', index=0))
    reader.tensor(buf4, (2708, 16), is_leaf=True)  # arg4_1
